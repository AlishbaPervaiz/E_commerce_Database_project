...
<head>
    ...
    <title>Order History - ShopZone Admin</title>
...
<div class="search-container mb-4">
    <form method="GET" action="admin_order_history.php" class="row g-3">
        <div class="col-md-8">
        ...
        <div class="col-md-4">
            <?php if (!empty($_GET['search'])): ?>
                <a href="admin_order_history.php" class="btn btn-outline-danger">
...
");
        ...
        if ($orders->num_rows === 0) {
            echo '<div class="alert alert-info">No order history found</div>';
        } else {
